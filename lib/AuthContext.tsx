...
export const AuthView = () => {
    ...
    return (
      <div className="flex flex-col items-center justify-center p-8">
        <div className="text-center">
          ...
          <a href="/" className="text-[#F6B45A] hover:underline font-bold">Go to Dashboard</a>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] p-4 bg-[#FDFCFB]">
      <div className="bg-white p-8 md:p-12 rounded-[32px] shadow-[0_20px_60px_-15px_rgba(0,0,0,0.1)] border border-gray-100 max-w-md w-full text-center">
        ...
        {AUTH_URL && (
          <p className="mt-6 text-[10px] text-gray-300 font-mono break-all">
            Connection: {AUTH_URL}
          </p>
        )}
      </div>
...
export const AccountView = () => {
  ...
  return (
    <div className="flex-1 flex flex-col items-center justify-center min-h-[60vh] p-4 bg-[#FDFCFB]">
        <div className="bg-white p-8 md:p-12 rounded-[32px] shadow-[0_20px_60px_-15px_rgba(0,0,0,0.1)] border border-gray-100 max-w-lg w-full">
            ...
            <div className="space-y-6">
                ...
                <div>
                    <label className="text-[10px] font-bold uppercase tracking-widest text-gray-400">Auth Provider</label>
                    <p className="text-lg font-medium text-[#111] mt-1">Neon Auth</p>
                </div>
