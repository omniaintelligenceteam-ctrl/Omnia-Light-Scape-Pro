...
import { Upload, Download, Loader2, RefreshCw, AlertCircle, ArrowRight, MousePointer2, ArrowUpFromLine, CircleDot, ChevronsUp, X, Sparkles, PencilLine, ThumbsUp, ThumbsDown, Save, ArrowLeft, Maximize2 } from 'lucide-react';
    ...
    return (
      <div className="h-screen w-full flex items-center justify-center bg-[#FDFCFB] font-sans text-[#111]">
        <div className="text-center space-y-8 max-w-md px-6">
          ...
          <h1 className="text-3xl font-black tracking-tight uppercase">Omnia's LightScape Pro</h1>
        ...
        <>
          ...
          <main className="flex-1 flex flex-col relative overflow-hidden h-screen">
            ...
            <header className="px-12 py-6 flex-shrink-0 flex justify-between items-end bg-[#111] shadow-2xl z-30">
              <div>
                <h1 className="text-4xl font-serif font-black tracking-tight mb-2 text-white"><span className="text-[#F6B45A]">Omnia's</span> LightScape Pro</h1>
                ...
                {uploadedImage && !generatedImage && (
                    ...
                    <div className="w-full max-w-4xl mx-auto flex flex-col gap-6">
                            ...
                            <div className="flex gap-4">
                                ...
                                `}
                                >
                                {isGenerating ? <Loader2 size={18} className="animate-spin" /> : <PencilLine size={18} />}
                                <div className="flex flex-col items-start leading-none">
                                    <span>Generate Manual Design</span>
                                </div>
                                </button>
                ...
                {generatedImage && (
                    <div className="flex flex-col gap-8 animate-in slide-in-from-bottom-8 fade-in duration-700 h-full">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-6xl mx-auto w-full">
                            {/* BEFORE IMAGE */}
                            <div className="relative rounded-[32px] overflow-hidden bg-white shadow-[0_30px_60px_-15px_rgba(0,0,0,0.15)] border border-white/80 w-full group ring-1 ring-black/5">
                                <div className="absolute top-6 left-6 z-10">
                                     <span className="bg-black/50 backdrop-blur-md text-white px-3 py-1 rounded-full text-[10px] font-bold uppercase tracking-widest border border-white/10">Before</span>
                                </div>
                            ...
                            >
                                <div className="absolute top-6 left-6 z-10">
                                     <span className="bg-[#F6B45A] text-black px-3 py-1 rounded-full text-[10px] font-bold uppercase tracking-widest shadow-lg">After</span>
                                </div>
